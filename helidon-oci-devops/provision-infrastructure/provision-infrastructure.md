...
3. Copy and paste the following command to the terminal to download the source code. This source code contains the terraform scripts which create the OCI resources required for this workshop.
    ...
    ```bash
    <copy>curl -O https://ocloud200.objectstorage.us-ashburn-1.oci.customer-oci.com/p/Gl61R_NEEOs2M_zI2i63n5I3v1yIKrOTaERkO9Z1zTFnL7TSVhsjmEgLMbIhrMVy/n/ocloud200/b/ecnj_livelabs/o/devops_helidon_to_instance_ocw_hol.zip
