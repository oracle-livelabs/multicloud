...
Remove the resources created in your Azure subscription to stop further charges.
...
After you complete the workshop, remove these resources from your Azure subscription:
...
7. Azure virtual network and subnets
