...
Verify the pre-created Azure and Oracle resources assigned to your workshop account.

### Objectives

* Verify the resource group, virtual network, and subnets.
* Verify Oracle Autonomous AI Database and record its connection string.
* Verify Azure OpenAI and Azure Machine Learning resources.

Estimated Time: 10 minutes

## Task 1: Verify the lab environment

The required workshop resources are pre-created. Verify each resource before you begin the hands-on labs.
